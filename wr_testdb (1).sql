...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2020 at 10:44 AM
...
CREATE TABLE `file_details` (
  ...
  `file_status` tinyint(4) NOT NULL COMMENT '1-in folder, 2-deleted'
...
ALTER TABLE `file_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `file_detail_id` (`file_detail_id`);
...
--
ALTER TABLE `file_history`
  ADD CONSTRAINT `file_history_ibfk_1` FOREIGN KEY (`file_detail_id`) REFERENCES `file_details` (`id`) ON UPDATE CASCADE;
COMMIT;
